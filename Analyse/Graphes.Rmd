...
View(base_emp_inno)
base_emp_inno[base_emp_inno$firm_name == '2Csi']$n_offres
```
...
# INNOVATION EN FONCTION DU nb d'offres d'emploi"
```{r}
base_emp_inno = fread("Data/base_emp_inno.csv")
...
# ipc main code et nb de brevets 
```{r}

base_emp_inno = fread("Data/base_emp_inno.csv")


ggplot(base_emp_inno, aes(x = ipc_main_code, y = n_patents, fill = ipc_main_code)) +
  geom_bar(stat = "identity") +
  scale_fill_viridis_d(
    breaks = unique(base_emp_inno$ipc_main_code[base_emp_inno$n_patents > 1250]),  # Filtrer la légende
    na.translate = FALSE
  ) +
  labs(
    title = "Nombre de brevets par code IPC principal",
    x = "Code IPC principal",
    y = "Nombre de brevets",
    fill = "Code IPC (nb brevets > 1250)"
  ) +
  theme_minimal() +
  theme(
